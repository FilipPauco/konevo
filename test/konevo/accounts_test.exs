defmodule Konevo.AccountsTest do
  use Konevo.DataCase

  alias Konevo.Accounts

  import Konevo.AccountsFixtures
  alias Konevo.Accounts.{User, UserToken}
  ...
  describe "change_user_password/3" do
    ...
    test "allows fields to be set" do
      ...
      assert get_change(changeset, :password) == "Hello world!1"
  ...
  describe "update_user_password/2" do
    ...
    test "validates maximum values for password for security", %{user: user} do
      ...
      assert "should be at most 35 character(s)" in errors_on(changeset).password
    end
  ...
  describe "password reset" do
    test "delivers a reset token and uses it to replace the password" do
      user = user_fixture() |> set_password()
    ...
    test "rejects an invalid reset token" do
      assert {:error, :invalid_token} =
               Accounts.reset_user_password("invalid", %{
                 "password" => valid_user_password(),
